function ops = KilosortConfiguration2(XMLfile)
...
ops.Th               = [6 10]; %[6 10 10];    % threshold for detecting spikes on template-filtered data ([6 12 12])
ops.lam              = 12; %[12 40 40];   % large means amplitudes are forced around the mean ([10 30 30])
ops.nannealpasses    = 4;            % should be less than nfullpasses (4)
ops.momentum         = [20 800]; %1./[20 800];  % start with high momentum and anneal (1./[20 1000])
