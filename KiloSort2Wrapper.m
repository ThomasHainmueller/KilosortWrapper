...
%
% Dependencies:  KiloSort2 (https://github.com/cortex-lab/KiloSort2)
%
%
...
% 
% Adapted from KiloSortWrapper by Brendon Watson and Peter Petersen, 2016
% Thomas Hainmueller, Buzsakilab, 2020
...
addParameter(p,'SSD_path','C:\DATA',@ischar)    % Path to SSD disk. Make it empty to disable SSD
...
createChannelMapFile_KSW(basepath,basename,'staggered-wide');
...
if isempty(config)
    ...
    ops = KilosortConfiguration2(XMLFilePath);
else
...
if isdir(SSD_path)
    ...
    ops.fbinary = fullfile(basepath,[basename,'.dat']);
